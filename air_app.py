...
def show_dashboard():
    ...
    with col4:
        st.metric("Avg Accuracy", f"{((model_metrics['rf_classifier']['accuracy'] + model_metrics['logistic_regression']['accuracy']) / 2 * 100):.0f}%", "+2%")
    ...
    with col1:
        # Accuracy comparison
        models = ['Random Forest (Clf)', 'Logistic Regression']
        accuracies = [
        ...
        fig = go.Figure(data=[
            go.Bar(
                ...
                text=[f'{score:.2%}' for score in accuracies],
...
def show_ml_predictor():
    ...
    with col2:
        ...
        if 'predicted_aqi' in st.session_state:
            ...
            if category == "Good":
                bg_color = "#28a745"
                advice = "Air quality is satisfactory. Safe for outdoor activities.No health problems."
            elif category == "Moderate":
                bg_color = "#ffc107"
                advice = "Acceptable quality. Unusually sensitive people should reduce outdoor time.Slighing discomfort for senitive people."
            elif category == "Unhealthy for Sensitive":
                bg_color = "#ff9800"
                advice = "People with respiratory issues should limit outdoor exertion.breathing difficulty."
            elif category == "Unhealthy":
                bg_color = "#dc3545"
                advice = "Everyone may begin to experience health effects.Couughing and throat irritation."
            elif category == "Very Unhealthy":
                bg_color = "#9c27b0"
                advice = "Health alert: everyone may experience serious effects.Serious breathing problems."
            else:  # Hazardous
                bg_color = "#7b1fa2"
                advice = "Emergency conditions: everyone should stay indoors.Risk of lung damage."
